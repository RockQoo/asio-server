...
namespace
{
    ...
    void TestFunc1(const bool enabled)
    {
        ...
        PushMsg(EMsgId::QueueTest, EWorldProcessorId::Test, 0, 10, "zeus",
    ...
    void TestFunc2(const bool enabled)
    {
        ...
        {
            PushMsg(EMsgId::LaneProbe, EWorldProcessorId::Test, kProbeOwnerId, seq, kProbeOwnerId);
        }
    }
    ...
    void TestFunc3(const bool enabled)
    {
        ...
        for (int32_t seq = 0; seq < kProbeCount; ++seq)
        {
            ...
            PushMsg(EMsgId::LaneProbe, EWorldProcessorId::Test, ownerId, seq, ownerId);
        }
    }
}
