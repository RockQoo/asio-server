...
namespace World
{
    // 프로세스 안에서만 도는 메시지 종류. **Protocol::PacketId와 무관하다** -- 와이어로
    ...
    //
    //   PushMsg(EMsgId::QueueTest, EProcessorId::Test, ownerId, 10, "zeus", value);
    //
    ...
    void PushMsg(const EMsgId msgId, const EProcessorId processorId, const uint64_t ownerId,
                 const TArgs&... args)
    {
