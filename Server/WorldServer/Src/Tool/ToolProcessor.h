...
namespace World
{
    ...
    // 클라이언트 패킷(Protocol::PacketId::C2ZMailAdd/MailDel)을 ClientEnvelopeHeader로 감싸 존에
    ...
    private:
        ...
        [[nodiscard]] bool InjectClientPacket(const Network::SessionId clientSessionId, const Protocol::PacketId innerPacketId,
