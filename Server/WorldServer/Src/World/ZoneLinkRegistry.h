...
namespace World
{
    ...
    public:
        ...
        void Add(const Common::ZoneId zoneId, const Network::Session::SPtr& zoneSession,
                 const float xMin, const float xMax, const float yMin, const float yMax);
        void Remove(const Common::ZoneId zoneId);
        ...
        [[nodiscard]] std::optional<ZoneLinkInfo> Find(const Common::ZoneId zoneId) const;
        [[nodiscard]] std::optional<Common::ZoneId> FindZoneContaining(const float x, const float y) const;
    ...
    private:
        std::unordered_map<Common::ZoneId, ZoneLinkInfo> zones_;
    };
}
