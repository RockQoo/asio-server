...
void ZoneLinkRegistry::Remove(const Common::ZoneId zoneId)
{
    zones_.erase(zoneId);
}
...
std::optional<ZoneLinkInfo> ZoneLinkRegistry::Find(const Common::ZoneId zoneId) const
{
...
std::optional<Common::ZoneId> ZoneLinkRegistry::FindZoneContaining(const float x, const float y) const
{
