...
// byte/size_t/고정폭 정수를 std:: 없이 쓰기 위한 전역 using 선언 모음 (Shared/Core/Src/pch.h와 동일한
// 이유로 예외 처리됨 — Shared/Core/Src/Common/BasicTypes.h 주석 참고).
#include "Shared/Core/Src/Common/BasicTypes.h"

// LOG.Error(category, "메시지").KV(...) 형태의 전역 로그 진입점 (Shared/Core/Src/pch.h와 동일한 이유로
