...
MailExpiryService::MailExpiryService(MailRegistry& mailRegistry, Network::SessionHolder& worldLink)
...
void MailExpiryService::SweepOnce(const int64_t nowUt)
{
                                         ...
                                         const std::shared_ptr<MailModel::Mutexed>& mailModel)
    {
        ...
        ZoneUnitOfWork unitOfWork(worldLink_, clientSessionId, playerId,
                                    ZoneUnitOfWork::Models{mailModel, nullptr});
