...
#pragma pack(pop)
    ...
    // 쓰는 쪽: ZoneServer/Src/Mail/MailModel.cpp(태스크별 payload 직렬화) +
    // ZoneServer/Src/Mail/MailUnitOfWork.cpp(playerId 접두 + UnitOfWorkStream 전송).
    // 읽는 쪽: WorldServer/Src/Handler/ZoneLinkHandler.cpp.
}
