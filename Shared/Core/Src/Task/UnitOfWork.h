...
namespace Task
{
    ...
    public:
        ...
        UnitOfWork(const uint64_t ownerId, const Common::RUID requestId);
        ...
        [[nodiscard]] Common::RUID GetRequestId() const noexcept { return requestId_; }
    ...
    public:
        ...
        RollbackUnitOfWork()
            : UnitOfWork(0, Common::kInvalidRUID)
        {
        }
