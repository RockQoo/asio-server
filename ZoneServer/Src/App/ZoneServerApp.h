...
#include "Core/Src/Network/Connector.h"
#include "Core/Src/Network/IoContextPool.h"
#include "ZoneServer/Src/Game/ZoneDef.h"
#include "ZoneServer/Src/Handler/WorldLinkHandler.h"
...
#include "ZoneServer/Src/Worker/ZoneWorkerManager.h"
...
namespace Zone
{
    ...
    // 한데 묶는다 -- 후자가 Synchronized가 실제로 필요한 유일한 지점이다(ZoneWorld.h 상단 주석
    // 참고).
    class ZoneServerApp
    {
    public:
