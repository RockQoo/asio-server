...
namespace Mail
{
    // 이 존에 있는 모든 플레이어의 MailModel::ARef(=Synchronized<MailModel>)를 들고 있는
    ...
    public:
        ...
        [[nodiscard]] std::shared_ptr<MailModel::ARef> Find(const Network::SessionId clientSessionId) const;
    ...
    private:
        ...
        std::unordered_map<Network::SessionId, std::shared_ptr<MailModel::ARef>> mails_;
    };
}
